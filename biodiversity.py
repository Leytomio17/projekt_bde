...
# 
# Use <a>Codecademy's sample size calculator</a> to calculate the number of sheep that they would need to observe from each park.  Use the default level of significance (90%).
# 
...
# Approximately three and a half weeks at Bryce and one and a half weeks at Yellowstone.
